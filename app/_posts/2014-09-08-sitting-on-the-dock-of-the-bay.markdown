...
![The Stavros S Niarchos leaving Cardiff Docks]({{ site.url }}/img/{{ page.date | date: "%Y-%m-%d"}}-{{page.slug}}/2014-04-29-19.51.42-copy-1024x650.jpg)
...
![View over Cardiff Bay from Northcliffe]({{ site.url }}/img/{{ page.date | date: "%Y-%m-%d"}}-{{page.slug}}/2014-03-07-11.08.36-copy-1024x456.jpg)
