...
(function(){
    ...
    var year_chart_2015 = new DayChart("#year2015 .vis", 2015);
    var year_chart_2016 = new DayChart("#year2016 .vis", 2016);
    ...
    function do_dashboard(date_query) {
        ...
        yesterday.setUTCHours(yesterday.getUTCHours()+5);
    ...
    function calc_time(checkins) {
        ...
        d3.xhr("http://bardiff-martinjc.rhcloud.com/api/checkins", function(err, checkins){
            ...
            year_chart_2015.draw();
            year_chart_2016.add_data(checkins);
            year_chart_2016.draw();
        });
    }
}());